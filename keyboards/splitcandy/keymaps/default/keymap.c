...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [_BASE] = LAYOUT(
        TD(Q_CTL),      KC_W,       KC_E,           KC_R,               KC_T,
        KC_A,           KC_S,       KC_D,           KC_F,               KC_G,
        LCTL_T(KC_Z),   KC_X,       KC_C,           KC_V,               KC_B,
                                    KC_LCTL,        LSFT_T(KC_SPACE),   MO(_LAYER1)
    ),
    /*
     * ┌─────┬─────┬─────┬─────┬─────┐
     * │  1  │  2  │  3  │  4  │  5  │
    ...
    [_LAYER1] = LAYOUT(
        ...
        KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_VOLD,           KC_VOLU,
                                KC_ENT,     KC_BACKSPACE,      KC_NO
    )
};
...
tap_dance_action_t tap_dance_actions[] = {
    [Q_CTL] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, q_finished, q_reset)
};
